...
struct MockDataPreviewService {
    ...
    static let frontRow = Array(repeating: GridItem(.fixed(108), spacing: 50.0, alignment: .top), count: 4)
    static let secondRow = Array(repeating: GridItem(.fixed(108), spacing: 60.0, alignment: .top), count: 5)
